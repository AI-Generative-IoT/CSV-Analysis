...
########################################################################
#                                                                      # 
#   PYTHON ROUTINE zum Vertauschen zweier Spalten in einem CSV-File    #
#                                                                      # 
######################################################################## 
...
for i in range(0, num_cols): # Initiiere den Austausch von Daten zwischen Spalten 1 und 4
    ...
    df['Spalte 1'][i] = df['Spalte 1'][i] # Schreibe die Daten aus der Spalte 4 in die Spalte 1
    df['Spalte 1'][i] = buffer # Schreibe die Daten aus dem Puffer in die Spalte 4
