...
# PYTHON ROUTINE zur numerischen Verifikation des Gaußschen Grenzwertsatzes #
...
M = 100000 # Definiere eine Anzahl von Iterationen
...
for l in range(M):
    ...
    random_var = 0.0 # Setze die Zufallsvariablen auf den Wert 0 
