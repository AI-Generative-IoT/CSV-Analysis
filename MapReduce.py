...
# PYTHON ROUTINE für die Realisierung einer MapReduce Instanz #
...
def product(m, n) : # Funktion zur Matrixmultiplikation

    result = [[sum(a*b for a,b in zip(M_row,N_col)) for N_col in zip(*N)] for M_row in M] # Führe die Matrixmultiplikation aus
...
print(reduce_instance) # Zeige das Ergebnis
